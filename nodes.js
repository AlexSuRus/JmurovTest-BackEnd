const node0 = {id: 0, texts: 'Тест для диагностики депрессивных состояний. Методика Жмурова состоит из 45 вопросов и предназначена для выявления тяжести депрессивного состояния на момент обследования у взрослых. Прочтите каждую группу показаний и выберите подходящий вариант ответа — 1, 2, 3 или 4. Внимательно прочитайте каждую группу утверждений. Затем определите в каждой группе одно утверждение, которое лучше всего соответствует тому, как Вы себя чувствовали на этой неделе и сегодня.', options: [{text: ['Нажимая на кнопку, я подтвержаю своё совершеннолетие. Начать тест', '1']}]}
